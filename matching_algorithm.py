...
##############PREDICTION#######################
str_list = {
        "Mouth": ['D021'], "House": [ 'O001'], "Man and his occupation": [ 'A001'],"backward motion":['D055'],"Hare":['E034'],
        "King": [ 'A040'], "Soker (The god)": ['O004 V031 D021 A040'],"Owl": ['G017'], "Morning": ['N014'],
        "Sun": [ 'N005'], "Day": [ 'O004 D021 G001 N005'],"Folded cloth":['S029'], "Water ripple":['N035'],
...
def dictionary_matching(top1):
    ...
    if temp in val_list:
        ...
        ind=val_list.index(temp)
        ans = key_list[ind]

        # if val_list.index(temp):
        #     # ind=val_list.index(temp)
        #     # ans = key_list[ind]
        # else:
        #     ans=" "
