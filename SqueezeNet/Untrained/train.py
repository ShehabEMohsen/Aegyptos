...
def train(train_dir, mean_image_path, batchsize, num_epochs, 
    ...
    train=os.listdir('/content/gdrive/Shareddrives/Graduation Project (Kemet)/Datasets/SampleDataSet/train')
    X_train=[]
    X_train_arr = []
    ...
    for folderName in train:   
        for image_filename in tqdm(os.listdir('/content/gdrive/Shareddrives/Graduation Project (Kemet)/Datasets/SampleDataSet/train/' + folderName)):
                    print(image_filename)
                    img_file = cv2.imread('/content/gdrive/Shareddrives/Graduation Project (Kemet)/Datasets/SampleDataSet/train/'+ folderName + '/' +image_filename)
                    ...
                    # y_val.append(folderName)
                    # tensor_train = tf.convert_to_tensor(y_val_arr)
    ...
    data_test = []
    x_test = []
    file1=os.listdir('/content/gdrive/Shareddrives/Graduation Project (Kemet)/Datasets/SampleDataSet/test' )

    for folderName in file1:   
        for image_filename in tqdm(os.listdir('/content/gdrive/Shareddrives/Graduation Project (Kemet)/Datasets/SampleDataSet/test/' + folderName)):
                    print(image_filename)
                    img_file = cv2.imread('/content/gdrive/Shareddrives/Graduation Project (Kemet)/Datasets/SampleDataSet/test/'+ folderName + '/' +image_filename)
                    img_file = cv2.cvtColor(img_file, cv2.COLOR_BGR2GRAY)
                    img_arr = np.asarray(img_file)
                    # img_arr=img_arr/255
    ...
    file1=os.listdir('/content/gdrive/Shareddrives/Graduation Project (Kemet)/Datasets/SampleDataSet/val' )

    for folderName in file1:   
        for image_filename in tqdm(os.listdir('/content/gdrive/Shareddrives/Graduation Project (Kemet)/Datasets/SampleDataSet/val/' + folderName)):
                    print(image_filename)
                    img_file = cv2.imread('/content/gdrive/Shareddrives/Graduation Project (Kemet)/Datasets/SampleDataSet/val/'+ folderName + '/' +image_filename)
                    img_file = cv2.cvtColor(img_file, cv2.COLOR_BGR2GRAY)
                    img_arr = np.asarray(img_file)
                    # img_arr=img_arr/255

                    y_val.append(folderName)
                    data_val.append(img_arr)
                    img_file=None
                    img_arr=None
        ...
        # tensor_val = tf.convert_to_tensor(data_val)
        print(x_val.shape)
